...
uint64_t count_inversions0(uint32_t beg, uint32_t end)
{
    uint64_t invs = 0;
...
uint64_t count_inversions1(uint32_t beg, uint32_t end)
{
    ...
    uint64_t invs = count_inversions1(beg,mid) + count_inversions1(mid,end);
